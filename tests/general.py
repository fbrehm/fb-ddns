...
# -*- coding: utf-8 -*-
"""
@summary: Functions and objects used for unit tests on the fb-ddns python modules.
...
# =============================================================================
class FbDdnsTestcase(unittest.TestCase):
    ...
    def __init__(self, methodName="runTest", verbose=0):
        ...
        super(FbDdnsTestcase, self).__init__(methodName)
